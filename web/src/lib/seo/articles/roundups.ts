...
export const ROUNDUPS: ArticleEntry[] = [
  {
    ...
    body: [
      ...
      },
      {
        kind: "capture",
        caption:
          "What the phone opens onto instead of a host list: the standing sessions themselves, from several machines, each one the terminal that was already running.",
      },
    ],
    ...
    related: [
      {
        ...
        blurb: "the app versus no app, row by row",
        href: "/spawnd-vs-mobile-ssh-apps",
      },
      {
        title: "spawnd vs mosh",
        blurb: "the protocol the good phone clients ride",
        href: "/spawnd-vs-mosh",
      },
      {
        title: "spawnd vs SSH + tmux",
        blurb: "the plumbing every client inherits",
...

  {
    ...
    body: [
      ...
      },
      {
        kind: "capture",
        caption:
          "The agents drawn on the machines: one workspace per project, sessions from several hosts in one grid, each a real terminal, whichever agent is inside it.",
      },
    ],
    ...
    related: [
      {
        ...
        blurb: "the fleet shape, with the workspace grid as the console",
      ...
      },
      {
        ...
        blurb: "the yes an agent is waiting for, from anywhere",
