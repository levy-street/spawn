...
export const CLAUDE_CODE: ArticleEntry[] = [
  {
    ...
    body: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Claude Code runs in it exactly as it runs in any terminal — signed in on the host with your own plan, no API-key markup, `--remote-control` included if you want the Claude app view as well. Codex, OpenCode, and Aider ship as shortcuts alongside it, and any CLI can be added. Workspaces group sessions by project across hosts, attention cues show which agent is waiting on a yes, and notifications reach the phone. The phone half of this is walked through with real captures on [Claude Code on your phone](/claude-code-on-your-phone); the many-machines half on [run agents in parallel](/run-agents-in-parallel).",
        ],
      },
      {
        kind: "capture",
        caption:
          "The console for the machines the routes above cover one at a time: a workspace per project, sessions from several hosts in one grid, each a real terminal on the machine that owns its checkout.",
      },
    ],
    ...
    related: [
      ...
      },
      {
        ...
        blurb: "a fleet of sessions across machines, one console",
        href: "/run-agents-in-parallel",
      },
      {
        title: "spawnd vs SSH + tmux",
        blurb: "the classic route, measured row by row",
...

  {
    ...
    related: [
      ...
      {
        title: "Run agents in parallel",
        blurb: "the 20x workload: several sessions, one console",
        href: "/run-agents-in-parallel",
      },
    ],
...

  {
    ...
    related: [
      ...
      },
      {
        ...
        blurb: "the agent on every host you own, one console",
...

  {
    ...
    body: [
      ...
      },
      {
        kind: "capture",
        caption:
          "The four o’clock view: a workspace per project, sessions from three hosts in one grid, and the one that is waiting on an approval marked as such.",
      },
    ],
    ...
    related: [
      {
        title: "Run agents in parallel",
        blurb: "the fleet view a team lead actually wants",
        href: "/run-agents-in-parallel",
      },
      {
        title: "Keep agents running",
        blurb: "overnight runs that survive the closed laptop",
...
export const CLAUDE_CODE_HUB: HubEntry[] = [
  {
    ...
    spokes: [
      {
        ...
        blurb: "Remote Control, the web, SSH + tmux — then the machines they leave out",
        href: "/claude-code-remote",
      },
      {
        title: "Claude Code on the Max plan",
        blurb: "the 5x and 20x tiers, the two limit clocks, and making one plan stretch",
        href: "/claude-code-max-plan",
      },
      {
        title: "Is Claude Code free?",
      ...
      },
      {
        ...
        blurb: "the Team and Enterprise plans, then the files a team checks in",
        href: "/claude-code-teams",
      },
      {
        title: "Is Claude Code open source?",
        blurb: "it isn’t — the agents that are, and the open stack around it",
        href: "/claude-code-open-source",
      },
      {
        title: "Claude vs Claude Code",
        blurb: "the chat app and the terminal agent, and which one you actually need",
        href: "/claude-vs-claude-code",
      },
      {
        title: "How to run Claude Code",
        blurb: "install, sign in, first session — the canonical first hour",
        href: "/how-to-run-claude-code",
      },
      {
        title: "Claude Code settings",
        blurb: "settings.json scope by scope, and what belongs in each file",
        href: "/claude-code-settings",
      },
      {
        title: "Claude Code commands",
        blurb: "the slash commands and flags, and what each one actually does",
        href: "/claude-code-commands",
      },
      {
        title: "“Claude Code might not be available in your country”",
        blurb: "what the message means and the fixes that hold",
        href: "/claude-code-not-available-in-your-country",
      },
      {
        title: "Claude plan calculator",
        blurb: "Pro, Max 5x, or 20x — worked out from the hours you actually run",
        href: "/claude-plan-calculator",
      },
      {
        title: "Claude Code on your phone",
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Yes — through the Claude app with Remote Control or a web session, through an SSH app into a machine that runs it, or through a browser console like spawnd, where the session stays on your own machine. The remote and phone pages compare them.",
      },
      {
