// Small incremental SHA-256 used so host file transfers never need to buffer a
// complete file merely to declare/verify its digest. WebCrypto only exposes a
// one-shot digest API.
