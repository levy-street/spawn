...
export const FIXES_AND_ESSAYS: ArticleEntry[] = [
  {
    ...
    related: [
      ...
      },
      {
        ...
        blurb: "The definition, the history, the bill, and the self-hosted kind.",
        href: "/cloud-development-environment",
      },
    ],
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            body: "The session lives on the host and any browser attaches to it — from self-hosted web terminals to spawnd. The connection becomes disposable because nothing is stored in it; scrollback is wherever the session is.",
          },
        ],
      },
      {
