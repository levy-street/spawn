    ...
    body: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "It is not screen sharing and does not pretend to be — for the monthly GUI job keep Screen Sharing or RustDesk beside it. For the daily shell the Mac stops needing a hole in the router or a client on every device; if you keep Tailscale for the rest, [Tailscale stuck on Starting…](/tailscale-stuck-on-starting) is the fix page for the day it hangs.",
        ],
      },
    ],
