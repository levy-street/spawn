 ...
 * locates them (`agent.transcripts`) and the browser reads them like any other
...
): { agent: Agent; query: AgentTranscriptQuery } | null {
...
/** One title and one sentence for a dialog with nothing to list. */
