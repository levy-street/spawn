...
export default function ClaudePlanCalculatorPage() {
  return (
    ...
    >
      <Section>
        <Prose>
          <H2>Three plans, one pool of usage.</H2>
      ...
      <Section>
        <Prose>
          <H2>How Claude Code spends a plan.</H2>
          <div className="mt-8 space-y-5">
            <p>
          ...
          <div className="mt-10">
            <CodeFigure caption="Inside Claude Code. /usage shows the plan bars and the session’s token stats; /cost is its alias.">
      ...
      <Section>
        <Prose>
          <H2>Is extra usage worth it, or the next plan up?</H2>
          <div className="mt-8 space-y-5">
            <p>
      ...
      <Section>
        <Prose>
          <H2>Whichever plan you pick, the CLI logs in on the host.</H2>
          <div className="mt-8 space-y-5">
            <p>
            ...
            <p>
              ...
              <Link prefetch={false} href="/agentic-orchestration" className={LINK}>
                Orchestrating several agents at once
              </Link>{" "}
              is where that starts to matter; the{" "}
              <Link prefetch={false} href="/claude-code" className={LINK}>
                Claude Code pillar
              </Link>{" "}
              has the rest.
            </p>
      ...
      <Start heading="One subscription, every host you own." />
    </Frame>
  );
}
