...
import { CodeFigure, Frame, H2, LINK, Prose, Section, Start } from "@/components/grimoire/frame";
...
const RELATED = [
  {
    title: "mosh vs SSH",
    blurb: "How mosh differs from SSH, what it drops, and the modern alternatives.",
    href: "/mosh-vs-ssh",
  },
  {
    title: "Background agents",
    blurb: "What a background agent is, which products use the term, and what one needs.",
    href: "/background-agents",
  },
  {
    title: "Claude Code, remote",
    blurb: "Remote Control, the web, and SSH — how each works and where all three stop.",
...
export default function TmuxCheatsheetPage() {
  return (
    ...
    >
      <Section>
        <Prose>
          <H2>One server, sessions, windows, panes — and a prefix.</H2>
          ...
          <div className="mt-10">
            <CodeFigure caption="The three commands that cover most days.">
      ...
      <Section>
        <Prose>
          <H2>Persistence in tmux is a discipline.</H2>
          <div className="mt-8 space-y-5">
            <p>
            ...
            <p>
              <Link prefetch={false} href="/claude-code-remote" className={LINK}>
                Claude Code, remote
              </Link>{" "}
              walks the SSH-and-tmux route as numbered steps, including where the classic is still
              the right answer;{" "}
              <Link prefetch={false} href="/background-agents" className={LINK}>
                background agents
              </Link>{" "}
              is the job persistence was built for.
            </p>
          </div>
        </Prose>
      </Section>
      ...
      <Section className="py-8 sm:py-10">
        <Prose>
          <p className="text-[15px] leading-7">
            ...
            <Link prefetch={false} href="/security" className={LINK}>
      ...
      <Start heading="Persistence without the prefix." />
    </Frame>
  );
}
