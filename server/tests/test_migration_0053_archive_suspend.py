"""Migration 0053: archiving becomes suspend, so the snapshot column goes.

Under 0051 an archived workspace had its sessions deleted and its shape held
...
The one thing 0053 has to be careful about is a workspace archived under the
...
def test_0053_drops_the_shape_and_frees_snapshot_era_archives(tmp_path: Path):
