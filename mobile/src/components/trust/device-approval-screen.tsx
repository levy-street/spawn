...
export function DeviceApprovalBody({
  ...
  // A phone with no registered identity is neither approved nor waiting: no
  // host can have pinned a key the server never accepted, whatever the trust
  // probe says about the stale one.
