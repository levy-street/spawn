...
the expected commit, unless the manifest names a commit with the same
`daemon/` tree, the case where a deploy kept the release it already had. It also continues to prove
