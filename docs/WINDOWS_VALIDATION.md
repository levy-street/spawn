...
- [ ] **Firewall + ICE**
  ...
  - **Expect:** No silent installer rule or any-program/Public rule; program-scoped Private UDP 50000–50999 enables direct ICE (a rule for the earlier 50000–50100 range must be re-created); removing/blocking still connects through outbound UDP TURN; record actual rules.
