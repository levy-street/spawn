...
separate semantic pass binds each status predicate to its grammatical subject
and rejects any claim that promotes P2-DATA or its durable store/contract beyond
